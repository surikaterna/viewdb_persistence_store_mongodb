var MongoOplog = require('surikat-mongo-oplog');
var _ = require('lodash');

var TICK_INTERVAL = 1000 * 60 * 5;
var OPLOG_WARN_THRESHOLD = 1000 * 5;
var OplogListener = function (mongodb, namespaceFilter, mongodbOplog) {
  var self = this;
...
OplogListener.prototype._onError = function (err) {
  ...
  setTimeout(function () {
    self._oplog = MongoOplog(self._mongodbOplog, self._options);
...
OplogListener.prototype.onOperation = function (doc) {
  ...
  var listeners = _.filter(this._listeners, function (listener) {
    return listener.namespace.toString() === doc.ns
  });
