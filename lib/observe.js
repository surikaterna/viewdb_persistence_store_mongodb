...
var Observer = function (query, queryOptions, collection, options, mongodb) {
  var self = this;
  ...
  var mongodbOplog = mongodb.db('local'); // for opload observer

  this._oplog = MongoOplog(mongodbOplog, { ns: namespace });
  ...
  return {
    stop: function () {
      return self._oplog.stop().then(function () {
        self._cache = null;
      });
    }
  }
