...
var Cursor = function (collection, query, options, cursor, oplog) {
  this._query = query;
...
Cursor.prototype.setReadPreference = function () {
  return this._cursor.setReadPreference.apply(this._cursor, arguments);
};

Cursor.prototype.count = function () {
  return this._cursor.count.apply(this._cursor, arguments);
};

Cursor.prototype.project = function () {
...
Cursor.prototype.observe = function (options) {
  return new Observer(this._query, this._queryOptions, this._collection,  options, this._oplog);
};
